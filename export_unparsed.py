...
@torch.no_grad()
def run(data, weights, imgsz, batch_size, device, include, half, inplace, train, keras,optimize, int8, dynamic,
        simplify,opset, verbose, workspace, nms, agnostic_nms, topk_per_class, topk_all,iou_thres, conf_thres):
    t = time.time()
...
def main():
    ...
    iou_thres = 0.45
    conf_thres = 0.25
    run(data, weights, imgsz, batch_size, device, include, half, inplace, train, keras,optimize, int8, dynamic,
        simplify,opset, verbose, workspace, nms, agnostic_nms, topk_per_class, topk_all,iou_thres, conf_thres)
